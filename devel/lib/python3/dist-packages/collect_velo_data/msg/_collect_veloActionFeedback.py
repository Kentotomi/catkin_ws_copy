...
"""autogenerated by genpy from collect_velo_data/collect_veloActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class collect_veloActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "collect_velo_data/collect_veloActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','collect_velo_data/collect_veloFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(collect_veloActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = collect_velo_data.msg.collect_veloFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = collect_velo_data.msg.collect_veloFeedback()
