...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_laserscan_SOURCE_PREFIX /home/kento/catkin_ws/src/velodyne/velodyne_laserscan)
  set(velodyne_laserscan_DEVEL_PREFIX /home/kento/catkin_ws/devel)
  ...
  set(velodyne_laserscan_INSTALL_PREFIX /home/kento/catkin_ws/install)
...
if(NOT "/home/kento/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kento/catkin_ws/src/velodyne/velodyne_laserscan/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT velodyne_laserscan_NUM_DUMMY_TARGETS)
      set(velodyne_laserscan_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::velodyne_laserscan::wrapped-linker-option${velodyne_laserscan_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR velodyne_laserscan_NUM_DUMMY_TARGETS "${velodyne_laserscan_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::velodyne_laserscan::wrapped-linker-option${velodyne_laserscan_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND velodyne_laserscan_LIBRARIES "${interface_target_name}")
