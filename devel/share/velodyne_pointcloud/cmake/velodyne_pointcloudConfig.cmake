...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/kento/catkin_ws/src/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/kento/catkin_ws/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/kento/catkin_ws/install)
...
if(NOT "/home/kento/catkin_ws/devel/include;/home/kento/catkin_ws/src/velodyne/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/kento/catkin_ws/devel/include;/home/kento/catkin_ws/src/velodyne/velodyne_pointcloud/include")
  ...
  elseif(NOT "http://ros.org/wiki/velodyne_pointcloud " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/velodyne_pointcloud' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kento/catkin_ws/src/velodyne/velodyne_pointcloud/${idir}'.  ${_report}")
    endif()
    _list_append_unique(velodyne_pointcloud_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "velodyne_rawdata;data_containers")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT velodyne_pointcloud_NUM_DUMMY_TARGETS)
      set(velodyne_pointcloud_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::velodyne_pointcloud::wrapped-linker-option${velodyne_pointcloud_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR velodyne_pointcloud_NUM_DUMMY_TARGETS "${velodyne_pointcloud_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::velodyne_pointcloud::wrapped-linker-option${velodyne_pointcloud_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND velodyne_pointcloud_LIBRARIES "${interface_target_name}")
...
set(depends "angles;nodelet;roscpp;roslib;sensor_msgs;tf2_ros;velodyne_driver;velodyne_msgs;dynamic_reconfigure;diagnostic_updater")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${velodyne_pointcloud_dep}_FOUND)
      find_package(${velodyne_pointcloud_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${velodyne_pointcloud_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(velodyne_pointcloud_EXPORTED_TARGETS ${${velodyne_pointcloud_dep}_EXPORTED_TARGETS})
endforeach()
