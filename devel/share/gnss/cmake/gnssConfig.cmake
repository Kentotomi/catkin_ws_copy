...
if("TRUE" STREQUAL "TRUE")
  set(gnss_SOURCE_PREFIX /home/kento/catkin_ws/src/Autoware/ros/src/computing/perception/localization/lib/gnss)
  set(gnss_DEVEL_PREFIX /home/kento/catkin_ws/devel)
  set(gnss_INSTALL_PREFIX "")
  set(gnss_PREFIX ${gnss_DEVEL_PREFIX})
else()
  set(gnss_SOURCE_PREFIX "")
  set(gnss_DEVEL_PREFIX "")
  set(gnss_INSTALL_PREFIX /home/kento/catkin_ws/install)
...
if(NOT "/home/kento/catkin_ws/src/Autoware/ros/src/computing/perception/localization/lib/gnss/include/gnss " STREQUAL " ")
  set(gnss_INCLUDE_DIRS "")
  set(_include_dirs "/home/kento/catkin_ws/src/Autoware/ros/src/computing/perception/localization/lib/gnss/include/gnss")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Tomomi HORII <tomo@axe.bz>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gnss' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kento/catkin_ws/src/Autoware/ros/src/computing/perception/localization/lib/gnss/${idir}'.  ${_report}")
    endif()
