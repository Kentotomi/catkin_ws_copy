...
if("TRUE" STREQUAL "TRUE")
  set(graph_tools_SOURCE_PREFIX /home/kento/catkin_ws/src/Autoware/ros/src/util/packages/graph_tools)
  set(graph_tools_DEVEL_PREFIX /home/kento/catkin_ws/devel)
  ...
  set(graph_tools_INSTALL_PREFIX /home/kento/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'usuda <usuda@axe.bz>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'graph_tools' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'graph_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kento/catkin_ws/src/Autoware/ros/src/util/packages/graph_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT graph_tools_NUM_DUMMY_TARGETS)
      set(graph_tools_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::graph_tools::wrapped-linker-option${graph_tools_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR graph_tools_NUM_DUMMY_TARGETS "${graph_tools_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::graph_tools::wrapped-linker-option${graph_tools_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND graph_tools_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${graph_tools_dep}_FOUND)
      find_package(${graph_tools_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${graph_tools_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(graph_tools_EXPORTED_TARGETS ${${graph_tools_dep}_EXPORTED_TARGETS})
endforeach()
