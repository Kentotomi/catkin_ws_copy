...
let collect_veloGoal = require('./collect_veloGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class collect_veloActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new collect_veloGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = collect_veloGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new collect_veloActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = collect_veloGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new collect_veloGoal()
    }
...
module.exports = collect_veloActionGoal;
