...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pcl_SOURCE_PREFIX /home/kento/catkin_ws/src/velodyne/velodyne_pcl)
  set(velodyne_pcl_DEVEL_PREFIX /home/kento/catkin_ws/devel)
  ...
  set(velodyne_pcl_INSTALL_PREFIX /home/kento/catkin_ws/install)
...
if(NOT "/home/kento/catkin_ws/src/velodyne/velodyne_pcl/include " STREQUAL " ")
  set(velodyne_pcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/kento/catkin_ws/src/velodyne/velodyne_pcl/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kento/catkin_ws/src/velodyne/velodyne_pcl/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(velodyne_pcl_EXPORTED_TARGETS ${${velodyne_pcl_dep}_EXPORTED_TARGETS})
endforeach()
